...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '未成一簣，止，吾止；雖覆一簣，進，吾往,時止時行，其道光明！',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '乌托邦人', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '不成熟的思考片想', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://utopian.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'jing.aou@gmail.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  WIDGET_PET_LINK:
        ...
        'https://raw.githubusercontent.com/imuncle/live2d/master/model/rem/model.json', // 挂件模型地址 @see https://github.com/xiazeyu/live2d-widget-models
